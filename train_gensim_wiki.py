...
if __name__ == '__main__':
    ...
    model.wv.save_word2vec_format("../model/word2vec_org.vector",
                                  "../model/vocabulary",
                                  binary=False)
    ...
    model_selevtive = gensim.models.Word2Vec(sentences,
                                   size=400,
                                   window=5,
                                   min_count=1000, # choose the words which minimum count is 1000
                                   workers=multiprocessing.cpu_count())
    model_selevtive.save("../model/word2vec_selective.model")
    model_selevtive.wv.save_word2vec_format("../model/word2vec_selevtive.vector",
                                  "../model/vocabulary_selective",
                                  binary=False)
    end_2 = time()
